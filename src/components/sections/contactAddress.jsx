                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-7.5">
                    <SlideUp delay={2}>
                        <div className="bg-background rounded-md shadow-3xl pt-5 pb-7.5 px-7.5 text-center flex flex-col items-center">
                            ...
                            <p>Redddipalayam, Thanjavur, Tamil Nadu, India</p>
                        </div>
                    </SlideUp>
                    ...
                    <SlideUp delay={3}>
                        <div className="bg-background rounded-md shadow-3xl pt-5 pb-7.5 px-7.5 text-center flex flex-col items-center ">
                            ...
                            <p><a href="mailto:srikarpomkarpipom@gmail.com">srikarpomkarpipom@gmail.com</a></p>
                        </div>
                    </SlideUp>
                    ...
                    <SlideUp delay={4}>
                        <div className="bg-background rounded-md shadow-3xl pt-5 pb-7.5 px-7.5 text-center flex flex-col items-center">
                            ...
                            <p><a href="tel:+916385460349">(+91) 6385460349</a></p>
                        </div>
                    </SlideUp>
