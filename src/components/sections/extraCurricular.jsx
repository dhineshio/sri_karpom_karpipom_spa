        ...
        <section className="lg:pt-15 lg:pb-15 pt-10 pb-10 relative">
            <div className="container">
                <div className="flex flex-col justify-center items-center">
                    <SectionName className={"text-primary-foreground"}>Our Courses</SectionName>
                    <Title size={"3.5xl"} className={"mt-2.5 text-center max-w-[514px]"}>Two levels, one goal — fluent Tamil for every child</Title>
                </div>
...
const Card = ({ title, desc, src, icon, id }) => {
    ...
    return (
        <SlideUp delay={id} className="h-full">
            <div className="border border-[#F2F2F2] bg-background rounded-[10px] p-7.5 group/card layer-card h-full flex flex-col">
                ...
                <div className="pt-7.5 flex flex-col flex-1">
