    ...
    return (
        <div className="pt-[75px] overflow-x-hidden">
            <div className="flex lg:flex-row flex-col justify-center lg:items-center pt-7.5 pb-8 border-t border-t-white border-opacity-20">
                <p className={cn('wow fadeInLeft', color)} data-wow-delay=".3s">© <Link to="https://www.auctustechnologies.com/">Auctus Technologies</Link> 2026 | All Rights Reserved</p>
                {/* <ul className="flex items-center gap-7.5 wow fadeInRight" data-wow-delay=".3s">
                    <li><Link to="/terms-and-conditions" className={cn(``, color)}>Terms & Conditions</Link></li>
                    <li><Link to="/privacy-policy" className={cn(``, color)}>Privacy Policy</Link></li>
