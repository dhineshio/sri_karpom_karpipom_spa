...
const cardOneItems = [
    { src: portfolio_1, title: "Tamil Letter Recognition", col: "sm:col-start-1 md:col-end-5 sm:col-end-7 col-span-full sm:row-span-2" },
    { src: portfolio_2, title: "Letter Sound Practice", col: "md:col-start-5 md:col-end-10 sm:col-start-7 sm:col-end-13 col-span-full" },
    { src: portfolio_3, title: "Building Basic Words", col: "md:col-start-10 sm:col-start-7 sm:col-end-13 col-span-full" },
    { src: portfolio_5, title: "Writing Tamil Letters", col: "md:col-start-5 md:col-end-9 sm:col-start-1 sm:col-end-7 col-span-full" },
    { src: portfolio_6, title: "Fun Phonics Activity", col: "md:col-start-9 sm:col-span-6 sm:col-end-13 col-span-full" },
]
            ...
            {cardOneItems.map(({ src, title, col }) => (
                <div key={title} className={`${col} relative group/card`}>
                    ...
                    <div className="px-7.5 absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 h-[calc(100%-60px)] w-[calc(100%-60px)] opacity-0 invisible group-hover/card:visible group-hover/card:opacity-80 transition-all duration-500 bg-primary rounded-[10px] flex flex-col items-center justify-center">
                        <h5 className="text-center"><Link to={"/about-us"} className="text-cream-foreground text-2xl font-medium">{title}</Link></h5>
                        <p className="text-cream-foreground">Sri Karpom Karpippom</p>
