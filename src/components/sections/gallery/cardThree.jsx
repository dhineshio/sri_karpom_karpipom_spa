...
const cardThreeItems = [
    { src: portfolio_3, title: "Interactive Live Class", col: "sm:col-start-1 sm:col-end-7 col-span-full" },
    { src: portfolio_5, title: "Online Tamil Learning", col: "sm:col-start-7 sm:col-end-13 col-span-full" },
]
