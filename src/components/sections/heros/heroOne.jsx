...
import painting from "@/assets/images/banner/painting-ByNae3xf.png"
      ...
      <div className="container relative">
        <div className="flex flex-col items-center text-center relative z-10">
          <Title size={"7.5xl"} className={"font-normal max-w-[776px]"}>
            <span className="relative">Start Learning<span className="absolute -left-6 top-1 text-3xl text-[#0A6375]"><ThreeLine /></span></span>
          ...
          <p className="pt-5 max-w-[431px]">We provide engaging online Tamil classes designed to help children learn, grow, and build a strong foundation through fun activities.</p>
          <div className="mt-6">
