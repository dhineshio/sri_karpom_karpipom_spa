            ...
            <div className="bg-warm lg:py-15 py-10">
                <div className="container">
                    <div className="flex  md:flex-row flex-col justify-between items-center gap-10">
                        <div className="">
                            <h2 className="xl:text-[50px] lg:text-4xl md:text-2xl text-3xl font-bold leading-[117%]">{pageName}</h2>
                            <ul className="lg:pt-5 pt-3 flex items-center lg:gap-5 gap-2">
                                <li><Link to="/" className="lg:text-[24px] text-xl font-bold">Home</Link></li>
                                <li><FaAngleRight /> </li>
                                <li><p className="lg:text-[24px] text-xl font-bold text-muted-foreground">{breadcrumbCurrent}</p></li>
                            </ul>
                        </div>
